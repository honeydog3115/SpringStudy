...
public class PointcutExpressionTest {
    ...
    public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression("execution(public int " + "com.example.springbook.learningtest.spring.pointcut.Target.minus(int, int) " + "throws java.lang.RuntimeException)");
    ...
    public void pointcut() throws Exception {
        targetClassPointcutMatches("exection(* *(..))", true, true, true, true, true, true);
    }

    // 타입... 은 해당 타입의 배열로 받는다는 것
